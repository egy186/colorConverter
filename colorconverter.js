...
function main(key, value) {
    ...
    inputRangeSts[3].backgroundImage = 'linear-gradient(90deg, hsla(0, ' + colorConfig.s + '%, ' + colorConfig.l + '%, 1), hsla(60, ' + colorConfig.s + '%, ' + colorConfig.l + '%, 1) 16.66666667%, hsla(120, ' + colorConfig.s + '%, ' + colorConfig.l + '%, 1) 33.33333333%, hsla(180, ' + colorConfig.s + '%, ' + colorConfig.l + '%, 1) 50%, hsla(240, ' + colorConfig.s + '%, ' + colorConfig.l + '%, 1) 66.66666667%, hsla(300, ' + colorConfig.s + '%, ' + colorConfig.l + '%, 1) 83.33333333%, hsla(360, ' + colorConfig.s + '%, ' + colorConfig.l + '%, 1))';
